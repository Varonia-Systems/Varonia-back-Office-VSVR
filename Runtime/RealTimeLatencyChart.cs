...
public class RealTimeLatencyChart : MonoBehaviour
{
    ...
    void InitUI()
    {
        ...
        graphPanel.anchorMin = new Vector2(0f, 0f);   // ?? Align� en bas � gauche
    ...
    /// <summary>
    /// Appelle cette m�thode avec la latence que tu veux afficher (� chaque tick r�seau par exemple)
    /// </summary>
